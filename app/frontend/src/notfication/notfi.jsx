    ...
    return (
        <div className="flex flex-col items-center justify-center bg-base-100 w-full justify-items-center">
            ...
            <ul className="rounded-2xl w-full flex flex-col items-center  p-4 ">
                {messages.map((msg, i) => (
                    <Link to={`/home/search/user/${msg.from_id}`} key={i} className="bg-base-300  w-3/4 justify-items-center text-red-600 border-4 border-red p-4 mb-4 rounded-2xl hover:border-green-200 hover:bg-black">
